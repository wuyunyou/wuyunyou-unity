...
;
		...
		public virtual void ResetSavedInventory()
		{
			...
			Debug.LogFormat("Inventory save file deleted: " + DetermineSaveName() + " in folder " + _saveFolderName);
		}
		...
		public virtual bool SwapBetweenItemToInventory(int startIndex, Inventory targetInventory, int endIndex)
		{
			return MoveItemToInventory(startIndex, targetInventory, endIndex);
		}
	}
}